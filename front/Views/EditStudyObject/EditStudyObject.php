<?php pageHeader($data);?>
<?php getModal('AddStudyObjectModal', $data);?>
<?php getModal('EditStudyObjectModal', $data);?>
  ...
  <div class="col-10">
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <button class="btn btn-success" type="button" onclick="addStudyObjectModal()"><i class="fas fa-plus-circle"></i> Agregar</button>
      </div>
