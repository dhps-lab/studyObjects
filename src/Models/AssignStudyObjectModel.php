<?php
    class AssignStudyObjectModel extends Mysql{
        ...
        public function saveAssignStudyObject(int $codeTeacher, int $codeAcademicArea, int $codeStudyObjectt){
        ...
        public function updateAssignStudyObject(array $arrData){
